...
- [Projects Behavior](projects.md) - How areas relate to projects
- [Today Page Sections](today-page.md) - How area filtering affects Today view
- [Architecture Overview](/development/architecture) - Technical architecture
- [Backend Patterns](/development/backend-patterns) - Module structure
- [Database & Migrations](/development/database) - Data model details
- [Directory Structure](/development/directory-structure) - File locations

**Technical Implementation Files:**
- Area model: `/backend/models/area.js`
- Areas service: `/backend/modules/areas/service.js`
- Areas controller: `/backend/modules/areas/controller.js`
- Areas repository: `/backend/modules/areas/repository.js`
- Areas routes: `/backend/modules/areas/routes.js`
- Areas validation: `/backend/modules/areas/validation.js`
- Frontend components: `/frontend/components/Area/`
- Areas list page: `/frontend/components/Areas.tsx`
- Area detail page: `/frontend/components/Area/AreaDetails.tsx`
- Area modal: `/frontend/components/Area/AreaModal.tsx`
- Areas API client: `/frontend/utils/areasService.ts`
- Integration tests: `/backend/tests/integration/areas.test.js`
