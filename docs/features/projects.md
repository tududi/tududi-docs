...
- [Areas](areas.md) - Top-level organizational categories and project grouping
- [Recurring Tasks Behavior](recurring-tasks.md) - How recurring tasks work within projects
- [Today Page Sections](today-page.md) - How project tasks appear on Today page
- [Inbox Page](inbox.md) - How to create projects from inbox
