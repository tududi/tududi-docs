...
**See:** [Inbox Page documentation](inbox.md) for details
...
- See: [Inbox Page documentation](inbox.md)
...
- [Inbox Page](inbox.md) - Quick capture and conversion to notes
- [Today Page Sections](today-page.md) - Task-focused workflow
- [Architecture Overview](/development/architecture) - Technical architecture
- [Development Workflow](/development/development-workflow) - Working with the codebase
- [Common Tasks](/development/common-tasks) - How to modify notes functionality
