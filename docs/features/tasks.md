...
This document explains how tasks work in tududi from a user behavior perspective (excluding recurring tasks, which are covered in [recurring-tasks.md](recurring-tasks.md)). For technical implementation details, see the backend code in `/backend/modules/tasks/` and `/backend/models/task.js`.
...
- [Recurring Tasks Behavior](recurring-tasks.md) - How recurring tasks work
- [Today Page Sections](today-page.md) - Task filtering and display on Today page
- [Upcoming View](upcoming-view.md) - 7-day task preview
- [Projects](projects.md) - Project assignment and task organization
- [Tags System](tags.md) - Tagging and categorization
- [User Management](user-management.md) - Permissions and sharing
